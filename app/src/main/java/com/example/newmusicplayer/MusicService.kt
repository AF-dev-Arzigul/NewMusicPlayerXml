...
//                .setOnlyAlertOnce(true)
                ...
                .addAction(R.drawable.ic_round_skip_next, "Next", nextPendingIntent)
                .addAction(R.drawable.ic_round_close_24, "Exit", exitPendingIntent)
                .build()
...
//                        NowPlaying.binding.playPauseBtnNP.setBackgroundResource(R.drawable.play_icon)
                        NowPlaying.binding.playPauseBtnNP.setImageResource(android.R.drawable.ic_media_play)
...
//                        NowPlaying.binding.playPauseBtnNP.setBackgroundResource(R.drawable.pause_icon)
                        NowPlaying.binding.playPauseBtnNP.setImageResource(android.R.drawable.ic_media_pause)
